...
export function SliderScreen() {
  ...
  const [tickPosition, setTickPosition] = useState<TickPosition>(
  ...
  const orientationSelected = useMemo(
    () => OrientationList.findIndex((val) => val.data === orientation),
    [orientation],
  );
  const tickPositionSelected = useMemo(
    () => TickPositionList.findIndex((val) => val.data === tickPosition),
    [tickPosition],
  );
    ...
    <View style={styles.content}>
      ...
      <GridView verticalSpacing={4}>
        ...
        <GridRow>
          ...
          <GridColumn>
            <Text style={styles.itemOptionText}>Value ({value})</Text>
          </GridColumn>
        </GridRow>
        ...
        <GridRow>
          ...
          <GridColumn>
            <Text style={styles.itemOptionText}>Orientation</Text>
          </GridColumn>
        </GridRow>
        ...
        <GridRow>
          ...
          <GridColumn>
            <Text style={styles.itemOptionText}>Tick Position</Text>
          </GridColumn>
        </GridRow>
        ...
        <GridRow>
          ...
          <GridColumn>
            <Text style={styles.itemOptionText}>Inverted Appearance</Text>
          </GridColumn>
        </GridRow>
        ...
        <GridRow>
          ...
          <GridColumn>
            <Text style={styles.itemOptionText}>Inverted Controls</Text>
          </GridColumn>
        </GridRow>
      </GridView>
    </View>
