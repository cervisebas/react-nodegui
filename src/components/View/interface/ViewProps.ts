...
import { WidgetAttributesMap } from "./WidgetAttributesMap";
import { WindowFlagsMap } from "./WindowFlagsMap";
import React from "react";

export interface ViewProps<Signals extends object> extends RNProps {
  /**
